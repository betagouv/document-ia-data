...
- Nommage : `stg_<source>__<entite>`, puis un nom métier pour les core et analytics (`core_executions`, `analytics_daily_executions`).
...
- Chaque modèle a une entrée dans le fichier `_<dossier>__models.yml` du dossier, avec au minimum une description et un test d'unicité + non-nullité sur la clé primaire.
